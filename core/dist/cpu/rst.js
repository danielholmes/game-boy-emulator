...
var createRst = function createRst(opCode, address) {
  return new _instructions.InstructionDefinition(opCode, "RST $".concat(address.toString(16))).decrementStackPointer(2).loadProgramCounter().writeMemoryWordFromStackPointer().setProgramCounter(address);
};
